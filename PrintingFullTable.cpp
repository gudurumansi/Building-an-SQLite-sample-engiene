//STEP-7:  Reading Data using Full Table Scan
...
// Extract all columns for the selected table
void extractAllColumns(std::ifstream& file, unsigned rootPage, unsigned pageSize) {
...
int main() {
 ...
 extractAllColumns(file, tableList[choice].second, pageSize);
 return 0;
}
